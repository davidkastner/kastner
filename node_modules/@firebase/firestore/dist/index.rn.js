 ...
 */ function po(t) {
    return To(t) && !Mo(t).hr() && t.Wr.size > 0;
}
...
function Do(t) {
    return To(t) && !Fo(t).hr() && t.Qr.length > 0;
}
...
async function $o(t, e) {
    ...
    await async function(t, e) {
        ...
        if (n = e.code, yn(n) && n !== Q.ABORTED) {
            ...
            // restart.
                        Fo(t).wr(), await Po(t, (() => t.remoteSyncer.rejectFailedWrite(n.batchId, e))), 
...
class Ko {
    ...
    /** Returns a view snapshot as if all documents in the snapshot were added. */    static fromInitialDocuments(t, e, n, s) {
        ...
        })), new Ko(t, e, Uo.emptySet(e), i, n, s, 
        /* syncStateChanged= */ !0, 
...
async function Wo(t, e) {
    ...
    if (r || (i = !0, r = new jo), i) try {
        r.so = await n.onListen(s);
    } catch (t) {
        const n = Bo(t, `Initialization of query '${Ce(e.query)}' failed`);
 ...
 */ class Yo {
     ...
     */    oo(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new Ko(t.query, t.docs, t.oldDocs, e, t.mutatedKeys, t.fromCache, t.syncStateChanged, 
 ...
 */ class tc {
    ...
    po(t) {
        const e = new Map, n = new Zo(this.k);
     ...
     */    async complete() {
        const t = await Vr(this.localStore, new Zo(this.k), this.documents, this.mo.id), e = this.po(this.documents);
 ...
 */ class ic {
    ...
    e) {
        ...
        this.mutatedKeys = Nn(), this.Ao = ke(t), this.Ro = new Uo(this.Ao);
    }
    /**
 ...
 */ (t.type, e.type) || this.Ao(t.doc, e.doc))), this.So(n);
    ...
    // PORTING NOTE: Multi-tab only.
    xo() {
        return Ko.fromInitialDocuments(this.query, this.Ro, this.mutatedKeys, 0 /* Local */ === this.Eo);
    }
}
 ...
 */
        // PORTING NOTE: Multi-Tab only.
        (n), n.Wo = !1, await Oo(n.remoteStore, !1);
    }
}
 ...
 */ class Uc extends Bc {
    ...
    async initialize(t) {
        ...
        await Fc(this.tc.syncEngine), await vo(this.tc.remoteStore), 
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new Qc({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.enqueueAndForget((() => Go(t, o))), n.fromCache && "server" === s.source ? i.reject(new W(Q.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Yo(n, r, {
            includeMetadataChanges: !0,
 ...
 */
        return function(t) {
            const e = ga.get(t);
            e && (M("ComponentProvider", "Removing Datastore"), ga.delete(t), e.terminate());
 ...
 */ class iu {
     ...
     */    static fromBase64String(t) {
        try {
            return new iu(Et.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new iu(Et.fromUint8Array(t));
    }
    /**
...
/** The result of parsing "update" data (i.e. for an updateData call). */ class uu {
    constructor(t, 
...
/** A "context" object passed around while parsing user data. */ class lu {
    /**
...
/** Parse update data from a list of field/value arguments. */ function Iu(t, e, n, s, i, r) {
    ...
    const l = new yt(u);
    return new uu(h, l, o.fieldTransforms);
}
 ...
 */ function Vu(t, e, n) {
    ...
    // FieldPath.
    e = T(e)) instanceof nu) return e._internalPath;
    if ("string" == typeof e) return Du(t, e);
    throw Cu("Field path arguments must be of type string or ", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function Du(t, e, n) {
    if (e.search(Su) >= 0) throw Cu(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return new nu(...e.split("."))._internalPath;
    } catch (s) {
        throw Cu(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}
 ...
 */ class ku {
     ...
     */    data() {
        if (this._document) {
            if (this._converter) {
                ...
                const t = new xu(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    get(t) {
        if (this._document) {
            const e = this._document.data.field($u("DocumentSnapshot.get", t));
 ...
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */ function $u(t, e) {
    return "string" == typeof e ? Du(t, e) : e instanceof nu ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ class Mu extends ku {
     ...
     */    data(t = {}) {
        if (this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                const e = new Fu(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    get(t, e = {}) {
        if (this._document) {
            const n = this._document.data.field($u("DocumentSnapshot.get", t));
 ...
 */ class Lu {
    /** @hideconstructor */
    constructor(t, e, n, s) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = s, this.metadata = new Ou(s.hasPendingWrites, s.fromCache), 
        this.query = n;
    }
     ...
     */    forEach(t, e) {
        this._snapshot.docs.forEach((n => {
            t.call(e, new Fu(this._firestore, this._userDataWriter, n.key, n, new Ou(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query.converter));
        }));
    }
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((n => ({
                    type: "added",
                    doc: new Fu(t._firestore, t._userDataWriter, n.doc.key, n.doc, new Ou(t._snapshot.mutatedKeys.has(n.doc.key), t._snapshot.fromCache), t.query.converter),
                    oldIndex: -1,
                    newIndex: e++
                })));
            }
            {
                ...
                return t._snapshot.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new Fu(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Ou(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    let i = -1, r = -1;
...
function nh(...t) {
    return new eh("endBefore", t, /*before=*/ !0);
}

function sh(...t) {
    return new eh("endAt", t, /*before=*/ !1);
}

/** Helper function to create a bound from a document or fields */ function ih(t, e, n, s) {
    if (n[0] = T(n[0]), n[0] instanceof ku) return function(t, e, n, s, i) {
...
function rh(t, e, n) {
    ...
    throw new W(Q.INVALID_ARGUMENT, `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Ia(n)}.`);
}
 ...
 */ class ah {
    ...
    convertGeoPoint(t) {
        return new ou(Rt(t.latitude), Rt(t.longitude));
    }
    convertArray(t, e) {
 ...
 */ class lh {
    ...
    constructor(t, e) {
        ...
        this._dataReader = du(t);
    }
    set(t, e, n) {
        this._verifyNotCommitted();
        const s = fh(t, this._firestore), i = uh(s.converter, e, n), r = wu(this._dataReader, "WriteBatch.set", s._key, i, null !== s.converter, n);
        return this._mutations.push(r.toMutation(s._key, Ze.none())), this;
    }
    update(t, e, n, ...s) {
        this._verifyNotCommitted();
        const i = fh(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let r;
        return r = "string" == typeof (e = T(e)) || e instanceof nu ? Iu(this._dataReader, "WriteBatch.update", i._key, e, n, s) : Eu(this._dataReader, "WriteBatch.update", i._key, e), 
 ...
 */ function _h(t) {
    ...
    return ca(n, t._key).then((n => new Mu(e, s, t._key, n, new Ou(null !== n && n.hasLocalMutations, 
...
function Rh(t, ...e) {
    ...
    "object" != typeof e[o] || Ma(e[o]) || (r = e[o], o++);
    const c = {
 ...
 */ function vh(t, e, n) {
    const s = n.docs.get(e._key), i = new wh(t);
    return new Mu(t, i, e._key, s, new Ou(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ class Vh extends class {
    /** @hideconstructor */
    constructor(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = du(t);
    }
    /**
     ...
     */    get(t) {
        const e = fh(t, this._firestore), n = new hh(this._firestore);
        return this._transaction.lookup([ e._key ]).then((t => {
            if (!t || 1 !== t.length) return U();
            const s = t[0];
            if (s.isFoundDocument()) return new ku(this._firestore, n, s.key, s, e.converter);
            if (s.isNoDocument()) return new ku(this._firestore, n, e._key, null, e.converter);
            throw U();
        }));
    }
    set(t, e, n) {
        const s = fh(t, this._firestore), i = uh(s.converter, e, n), r = wu(this._dataReader, "Transaction.set", s._key, i, null !== s.converter, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = T(e)) || e instanceof nu ? Iu(this._dataReader, "Transaction.update", i._key, e, n, s) : Eu(this._dataReader, "Transaction.update", i._key, e), 
     ...
     * @returns A `DocumentSnapshot` with the read data.
     */    get(t) {
        const e = fh(t, this._firestore), n = new wh(this._firestore);
        return super.get(t).then((t => new Mu(this._firestore, n, e._key, t._document, new Ou(
        /* hasPendingWrites= */ !1, 
