 ...
 * limitations under the License.
 */
var M = "9.6.3", F = new h("@firebase/firestore");
...
function ps(t) {
    return ys(t) && !Cs(t).hr() && t.Wr.size > 0;
}
...
function Ts(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                e = W(t), n = xs(e), i = e.Qr.length > 0 ? e.Qr[e.Qr.length - 1].batchId : -1, r.label = 1;
...
function Es(t) {
    return ys(t) && !xs(t).hr() && t.Qr.length > 0;
}
...
function As(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            ...
            for (e = xs(t), n = 0, i = t.Qr; n < i.length; n++) o = i[n], e.Dr(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function Ds(t, e) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(i) {
            switch (i.label) {
              case 0:
                return e && xs(t).Sr ? [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                        var n, i;
                        return r(this, (function(r) {
                            switch (r.label) {
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 3:
                return a = r.sent(), c = Ls(a, "Initialization of query '" + xe(e.query) + "' failed"), 
                [ 2 /*return*/ , void e.onError(c) ];

              case 4:
                return n.queries.set(i, s), s.listeners.push(e), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                e.ro(n.onlineState), s.so && e.oo(s.so) && Ks(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ var Gs = /** @class */ function() {
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.ro = function(t) {
        ...
        t = Ms.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.ao = !0, 
        this.co.next(t);
    }, t;
}(), zs = /** @class */ function() {
    function t(t, 
    ...
    function t(t, e, n) {
        ...
        this.documents = [], this.progress = Hs(t)
        /**
    ...
    return t.prototype.yo = function(t) {
        ...
        for (var e = new Map, n = new Qs(this.k), r = 0, i = t; r < i.length; r++) {
            var o = i[r];
    ...
    t.prototype.complete = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , So(this.localStore, new Qs(this.k), this.documents, this.mo.id) ];
 ...
 */ var Ys = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = xn(), this.Ao = Le(t), this.Ro = new Ps(this.Ao);
    }
    ...
    t.prototype.Po = function(t, e) {
        var n = this, r = e ? e.vo : new Os, i = e ? e.Ro : this.Ro, o = e ? e.mutatedKeys : this.mutatedKeys, s = i, u = !1, a = Ie(this.query) && i.size === this.query.limit ? i.last() : null, c = Te(this.query) && i.size === this.query.limit ? i.first() : null;
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        return this.Eo = u, 0 !== o.length || a ? {
            snapshot: new Ms(this.query, t.Ro, i, o, t.mutatedKeys, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Co: s
        } : {
            Co: s
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(l) {
            switch (l.label) {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, s), [ 2 /*return*/ , (yu(t, e.targetId, u.Co), 
                                    u.snapshot) ];
                                }
                            }));
                        }));
              ...
              case 1:
                return s = l.sent(), u = new Xs(e, s.zn), a = u.Po(s.documents), c = On.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                h = u.applyChanges(a, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), yu(t, i, h.Co), f = new $s(e, i, u), 
...
/** Stops listening to the query. */ function ru(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o;
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 3:
                return du(n, i.targetId), [ 4 /*yield*/ , wo(n.localStore, i.targetId, 
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                ...
                }(n, o.batchId, i), [ 4 /*yield*/ , gu(n, o.changes) ];
              ...
              case 5:
                return s = r.sent(), u = Ls(s, "Failed to persist write"), i.reject(u), [ 3 /*break*/ , 6 ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                /* targetMismatches= */ new Tn(ct), u, a), [ 4 /*yield*/ , ou(n, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                n.Bo = n.Bo.remove(s), n.Uo.delete(e), mu(n), [ 3 /*break*/ , 4 ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                ...
                lu(n, i, /*error=*/ null), fu(n, i), n.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , gu(n, o) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                ...
                // listen events.
                lu(n, e, i), fu(n, e), n.sharedClientState.updateMutationState(e, "rejected", i), 
                [ 4 /*yield*/ , gu(n, o) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 3:
                return s = r.sent(), u = Ls(s, "Initialization of waitForPendingWrites() operation failed"), 
...
function pu(t, e) {
    ...
    var n = t.Bo.get(e);
    null !== n && (hs(t.remoteStore, n), t.Bo = t.Bo.remove(e), t.Uo.delete(n), mu(t));
}

function yu(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Ys ? (t.qo.addReference(o.key, e), vu(t, o)) : o instanceof Js ? (U("SyncEngine", "Document no longer in limbo: " + o.key), 
 ...
 */ function mu(t) {
    for (;t.Lo.size > 0 && t.Bo.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.Uo.set(r, new Zs(n)), t.Bo = t.Bo.insert(n, r), cs(t.remoteStore, new oi(ke(be(n.path)), r, 2 /* LimboResolution */ , st.I));
    }
}
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                ...
                n.sharedClientState.handleUserChange(e, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , gu(n, i.Gn) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return i = r.sent(), o = e.view.ko(i), [ 2 /*return*/ , (n.isPrimaryClient && yu(n, e.targetId, o.Co), 
                o) ];
            }
        }));
    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 3:
                ...
                // other clients.
                lu(n, e, o || null), fu(n, e), function(t, e) {
                    W(W(t).An).ee(e);
                }(n.localStore, e)) : G(), r.label = 4;

              case 4:
                return [ 4 /*yield*/ , gu(n, s) ];
...
function Su(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return Cu(n = W(t)), xu(n), !0 !== e || !0 === n.Wo ? [ 3 /*break*/ , 3 ] : (i = n.sharedClientState.getAllActiveQueryTargets(), 
                [ 4 /*yield*/ , _u(n, i.toArray()) ]);

              case 1:
                return o = r.sent(), n.Wo = !0, [ 4 /*yield*/ , Ns(n.remoteStore, !0) ];
              ...
              case 3:
                ...
                n.Fo.forEach((function(t, e) {
                    n.sharedClientState.isLocalQueryTarget(e) ? c.push(e) : h = h.then((function() {
                        return du(n, e), wo(n.localStore, e, 
                        /*keepPersistedTargetData=*/ !0);
                    })), hs(n.remoteStore, e);
                })), [ 4 /*yield*/ , h ]);

              case 4:
                return r.sent(), [ 4 /*yield*/ , _u(n, c) ];
              ...
              case 5:
                ...
                }(n), n.Wo = !1, [ 4 /*yield*/ , Ns(n.remoteStore, !1) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 3:
                return f < l.length ? (d = l[f], p = n.Mo.get(d), [ 4 /*yield*/ , Iu(n, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 9:
                return c = r.sent(), [ 4 /*yield*/ , nu(n, Au(v), a, 
                /*current=*/ !1) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 6:
                return r.sent(), du(n, e, o), [ 3 /*break*/ , 8 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function Nu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(p) {
            switch (p.label) {
              case 0:
                if (!(n = Cu(t)).Wo) return [ 3 /*break*/ , 10 ];
                o = 0, s = e, p.label = 1;
              ...
              case 3:
                return c = p.sent(), [ 4 /*yield*/ , nu(n, Au(a), c.targetId, 
                /*current=*/ !1) ];
...
function Cu(t) {
    var e = W(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = ou.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = bu.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = uu.bind(null, e), e.Oo.br = Bs.bind(null, e.eventManager), 
    e.Oo.zo = js.bind(null, e.eventManager), e;
}

function xu(t) {
    var e = W(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = au.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = cu.bind(null, e), 
    e
    /**
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 4:
                    return i._updateProgress(Hs(n)), o = new Ws(n, t.localStore, e.k), [ 4 /*yield*/ , e.Ho() ];
                  ...
                  case 11:
                    ...
                    // has newer version.
                    return a = r.sent(), [ 4 /*yield*/ , gu(t, a.In, 
                    /* remoteEvent */ void 0) ];
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 3:
                    ...
                    return r.sent(), [ 4 /*yield*/ , xu(this.tc.syncEngine) ];
                    ...
                    return [ 4 /*yield*/ , this.persistence.sn((function(t) {
                        return n(o, void 0, void 0, (function() {
                            return r(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , Su(this.tc.syncEngine, t) ];
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return su(n.syncEngine, t, 1 /* SharedClientState */);
                    }, this.remoteStore.remoteSyncer.handleCredentialChange = wu.bind(null, this.syncEngine), 
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 2:
                    return i = r.sent(), [ 2 /*return*/ , new zs(JSON.parse(i), t.length + n) ];
                }
            }));
        }));
    }, 
    ...
    return t.prototype.run = function() {
        ...
        this.ur.Zi((function() {
            return n(t, void 0, void 0, (function() {
                var t, e, n = this;
                return r(this, (function(r) {
                    return t = new Uu(this.datastore), (e = this.dc(t)) && e.then((function(e) {
            ...
            return n(t, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 5:
                        return t = r.sent(), n = Ls(t, "Failed to shutdown persistence"), e.reject(n), [ 3 /*break*/ , 6 ];
...
function Gu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), [ 4 /*yield*/ , zu(t) ];

              case 1:
                return i = s.sent(), U("FirestoreClient", "Initializing OnlineComponentProvider"), 
                [ 4 /*yield*/ , t.getConfiguration() ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return e = r.sent(), [ 2 /*return*/ , ((n = e.eventManager).onListen = eu.bind(null, e.syncEngine), 
                n.onUnlisten = ru.bind(null, e.syncEngine), n) ];
            }
        }));
    }));
}

/** Enables the network connection and re-enqueues all pending operations. */ function $u(t, e, i) {
    var o = this;
    void 0 === i && (i = {});
    var s = new J;
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function ua(t) {
 ...
 */ var ha = /** @class */ function() {
    ...
    function t(t, e, n) {
        ...
        /**
             ...
             */
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new ha({}), 
        this._settingsFrozen = !1, t instanceof ea ? this._databaseId = t : (this._app = t, 
        this._databaseId = function(t) {
            ...
            return new ea(t.options.projectId);
        }(t));
    }
    return Object.defineProperty(t.prototype, "app", {
        ...
        this._settings = new ha(t), void 0 !== t.credentials && (this._authCredentials = function(t) {
            if (!t) return new $;
            switch (t.type) {
              case "gapi":
                var e = t.client;
 ...
 */
        return t = this, (e = na.get(t)) && (U("ComponentProvider", "Removing Datastore"), 
        na.delete(t), e.terminate()), Promise.resolve();
        var t, e;
    }, t;
}();
 ...
 */ var da = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "_path", {
         ...
         */
        get: function() {
            return new ya(this.firestore, this.converter, this._key.path.popLast());
        },
        enumerable: !1,
        configurable: !0
    ...
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.isEmpty() ? null : new da(this.firestore, 
 ...
 */ function va(t, n) {
    ...
    if (t = I(t), ra("collection", "path", n), t instanceof fa) {
        var o = gt.fromString.apply(gt, e([ n ], r));
        return sa(o), new ya(t, /* converter= */ null, o);
    }
    if (!(t instanceof da || t instanceof ya)) throw new Y(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(gt.fromString.apply(gt, e([ n ], r)));
    return sa(s), new ya(t.firestore, 
    /* converter= */ null, s);
}
 ...
 */ function ma(t, e) {
    if (t = aa(t, fa), ra("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new Y(H.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new pa(t, 
    /* converter= */ null, 
    /**
...
function ga(t, n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = at.A()), ra("doc", "path", n), t instanceof fa) {
        var o = gt.fromString.apply(gt, e([ n ], r));
        return oa(o), new da(t, 
        /* converter= */ null, new Pt(o));
    }
    if (!(t instanceof da || t instanceof ya)) throw new Y(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(gt.fromString.apply(gt, e([ n ], r)));
    return oa(s), new da(t.firestore, t instanceof ya ? t.converter : null, new Pt(s));
}
 ...
 * Firestore database.
 */ function wa(t, e) {
    return t = I(t), e = I(e), (t instanceof da || t instanceof ya) && (e instanceof da || e instanceof ya) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function ba(t, e) {
    return t = I(t), e = I(e), t instanceof pa && e instanceof pa && t.firestore === e.firestore && Ne(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var Ea = /** @class */ function() {
    ...
    function n(t, n, r) {
        ...
        /**
             ...
             */
        return (i = e.call(this, t, n, r) || this).type = "firestore", i._queue = new Ia, 
...
function Na(t) {
    var e, n = t._freezeSettings(), r = function(t, e, n, r) {
        return new ta(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling, r.useFetchStreams);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new ju(t._authCredentials, t._appCheckCredentials, t._queue, r);
}
 ...
 */ function Ca(t, e) {
    Ua(t = aa(t, _a));
    var n = Da(t), r = t._freezeSettings(), i = new Mu;
    return Ra(n, i, new Pu(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function xa(t) {
    Ua(t = aa(t, _a));
    var e = Da(t), n = t._freezeSettings(), r = new Mu;
    return Ra(e, r, new Ou(r, n.cacheSizeBytes));
}
 ...
 */ function Oa(t) {
    ...
    /** Disables the network connection. Pending operations will not complete. */ (Da(t = aa(t, _a)));
}
...
function qa(t, e) {
    ...
    }(Da(t = aa(t, _a)), e).then((function(e) {
...
/** A "context" object passed around while parsing user data. */ var Ja = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Oc = function(e) {
        ...
        return vc(t, this.settings.methodName, this.settings.Kc || !1, this.path, this.settings.jc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Ya(this.$c) && Qa.test(t)) throw this.qc('Document fields cannot begin and end with "__"');
    }, t;
}(), Xa = /** @class */ function() {
    function t(t, e, n) {
...
/** Parse document data from a set() call. */ function Za(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.Qc(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    lc("Data must be an object, but it was:", s, r);
    var u, a, c = hc(r, s);
...
/** Parse update data from an update() call. */ function sc(t, e, n, r) {
    var i = t.Qc(1 /* Update */ , e, n);
    lc("Data must be an object, but it was:", i, r);
    var o = [], s = Yt.empty();
    yt(r, (function(t, r) {
        var u = yc(e, t, n);
    ...
    var u = new It(o);
    return new Ha(s, u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function uc(t, e, n, r, i, o) {
    var s = t.Qc(1 /* Update */ , e, n), u = [ dc(e, r, n) ], a = [ i ];
    ...
    for (var c = 0; c < o.length; c += 2) u.push(dc(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = Yt.empty(), l = u.length - 1; l >= 0; --l) if (!mc(h, u[l])) {
        var d = u[l], p = a[l];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = I(p);
    ...
    var m = new It(h);
    return new Ha(f, m, s.fieldTransforms);
}
 ...
 */ function ac(t, e, n, r) {
    return void 0 === r && (r = !1), cc(n, t.Qc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function cc(t, e) {
    ...
    return function(t, e) {
        ...
        if (!Ya(e.$c)) throw e.qc(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.qc("Unsupported field value: " + ua(t));
    }(t, e);
}
...
function fc(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof lt || t instanceof za || t instanceof Ka || t instanceof da || t instanceof Ga);
}
 ...
 */ function dc(t, e, n) {
    ...
    // FieldPath.
    (e = I(e)) instanceof Ba) return e._internalPath;
 ...
 * evaluated.
 */ function yc(t, n, r) {
    if (n.search(pc) >= 0) throw vc("Invalid field path (" + n + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, r);
    try {
        return (new (Ba.bind.apply(Ba, e([ void 0 ], n.split(".")))))._internalPath;
    } catch (e) {
        throw vc("Invalid field path (" + n + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, r);
    }
}
 ...
 */ var gc = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "id", {
         ...
         */
        get: function() {
            return new da(this._firestore, this._converter, this._key);
        },
        enumerable: !1,
        configurable: !0
    }), 
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new wc(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(bc("DocumentSnapshot.get", t));
 ...
 */
function bc(t, e) {
    return "string" == typeof e ? yc(t, e) : e instanceof Ba ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var Ic = /** @class */ function() {
    ...
    n.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new Ec(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    n.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(bc("DocumentSnapshot.get", t));
            if (null !== n) return this._userDataWriter.convertValue(n, e.serverTimestamps);
        }
    }, n;
}(gc), Ec = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    /**
...
}(Tc), Sc = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new Ic(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new Ec(n._firestore, n._userDataWriter, r.key, r, new Ic(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    return {
                        type: "added",
                        doc: new Ec(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Ic(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter),
                        oldIndex: -1,
                        newIndex: n++
                    };
                }));
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new Ec(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Ic(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
...
var Cc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = $a(t.firestore), n = function(t, e, n, r, i, o, s) {
            var u;
            if (i.isKeyField()) {
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || zc(s, o), 
            u = ac(n, "where", s, 
...
var Pc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        return new pa(t.firestore, t.converter, De(t._query, this.Xc, this.Zc));
    }, n;
}(Dc);
 ...
 * @returns The created {@link Query}.
 */ function Oc(t) {
    return ca("limit", t), new Pc("limit", t, "F" /* First */)
    /**
...
function Mc(t) {
    return ca("limitToLast", t), new Pc("limitToLast", t, "L" /* Last */);
}
...
var Fc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = Kc(t, this.type, this.ta, this.ea);
        return new pa(t.firestore, t.converter, function(t, e) {
...
function Bc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Uc("endBefore", t, /*before=*/ !0);
}

function jc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Uc("endAt", t, /*before=*/ !1);
}

/** Helper function to create a bound from a document or fields */ function Kc(t, e, n, r) {
    if (n[0] = I(n[0]), n[0] instanceof gc) return function(t, e, n, r, i) {
...
function Gc(t, e, n) {
    ...
    if (n instanceof da) return jt(t, n._key);
    throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: " + ua(n) + ".");
}
 ...
 */ var Wc = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new za(At(t.latitude), At(t.longitude));
        ...
        z(Ir(n));
        var r = new ea(n.get(1), n.get(3)), i = new Pt(n.popFirst(5));
        return r.isEqual(e) || 
...
var Yc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.convertBytes = function(t) {
        ...
        return new da(this.firestore, /* converter= */ null, e);
    }, n;
}(Wc), Jc = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, 
        this._dataReader = $a(t);
    }
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = Xc(t, this._firestore), i = Hc(r.converter, e, n), o = Za(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, $e.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, s = Xc(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof Ba ? uc(this._dataReader, "WriteBatch.update", s._key, e, n, r) : sc(this._dataReader, "WriteBatch.update", s._key, e), 
 ...
 */ function $c(t) {
    t = aa(t, da);
    var e = aa(t.firestore, _a);
    return $u(Da(e), t._key).then((function(n) {
        return lh(e, t, n);
    }));
}
 ...
 */ function th(t) {
    t = aa(t, da);
    var e = aa(t.firestore, _a), i = Da(e), o = new Zc(e);
    return function(t, e) {
        var i = this, o = new J;
        return t.asyncQueue.enqueueAndForget((function() {
            return n(i, void 0, void 0, (function() {
                            ...
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      ...
                                      case 2:
                                        return o = r.sent(), s = Ls(o, "Failed to get document '" + e + " from cache"), 
        ...
        return new Tc(e, o, t._key, n, new Ic(null !== n && n.hasLocalMutations, 
 ...
 */ function nh(t) {
    t = aa(t, pa);
    var e = aa(t.firestore, _a), n = Da(e), r = new Zc(e);
    return kc(t._query), Zu(n, t._query).then((function(n) {
        return new Sc(e, r, t, n);
    }))
    /**
                            ...
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      ...
                                      case 1:
                                        return n = r.sent(), o = new Xs(e, n.zn), s = o.Po(n.documents), u = o.applyChanges(s, 
                                        /* updateLimboDocuments= */ !1), i.resolve(u.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return a = r.sent(), c = Ls(a, "Failed to execute query '" + e + " against cache"), 
...
function oh(t, e, n) {
    t = aa(t, da);
    var r = aa(t.firestore, _a), i = Hc(t.converter, e, n);
    return fh(r, [ Za($a(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, $e.none()) ]);
}

function sh(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = aa(t, da);
    var o = aa(t.firestore, _a), s = $a(o);
    return fh(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = I(e)) || e instanceof Ba ? uc(s, "updateDoc", t._key, e, n, r) : sc(s, "updateDoc", t._key, e)).toMutation(t._key, $e.exists(!0)) ]);
}
 ...
 */ function uh(t) {
    return fh(aa(t.firestore, _a), [ new pn(t._key, $e.none()) ]);
}
 ...
 */ function ah(t, e) {
    var n = aa(t.firestore, _a), r = ga(t), i = Hc(t.converter, e);
    return fh(n, [ Za($a(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, $e.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function ch(t) {
    ...
    "object" != typeof s[c] || Ta(s[c]) || (a = s[c], c++);
    var h, f, l, d = {
    ...
    if (t instanceof da) f = aa(t.firestore, _a), l = be(t._key.path), h = {
        next: function(e) {
            s[c] && s[c](lh(f, t, e));
        },
        error: s[c + 1],
        ...
        var y = aa(t, pa);
        f = aa(y.firestore, _a), l = y._query;
        var v = new Zc(f);
        h = {
            next: function(t) {
                s[c] && s[c](new Sc(f, v, y, t));
            },
            error: s[c + 1],
            complete: s[c + 2]
        }, kc(t._query);
    ...
    return function(t, e, i, o) {
        var s = this, u = new Vu(o), a = new Gs(e, u, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return n(s, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
 ...
 */ function lh(t, e, n) {
    ...
    return new Tc(t, i, e._key, r, new Ic(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var dh, ph = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = Xc(t, this._firestore), i = new Zc(this._firestore);
        return e.prototype.get.call(this, t).then((function(t) {
            return new Tc(n._firestore, i, r._key, t._document, new Ic(
            /* hasPendingWrites= */ !1, 
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = $a(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = Xc(t, this._firestore), r = new Yc(this._firestore);
        return this._transaction.lookup([ n._key ]).then((function(t) {
            if (!t || 1 !== t.length) return G();
            var i = t[0];
            if (i.isFoundDocument()) return new gc(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new gc(e._firestore, r, n._key, null, n.converter);
            throw G();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Xc(t, this._firestore), i = Hc(r.converter, e, n), o = Za(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof Ba ? uc(this._dataReader, "Transaction.update", s._key, e, n, r) : sc(this._dataReader, "Transaction.update", s._key, e), 
            ...
            return n(i, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return n = r.sent(), new Bu(t.asyncQueue, n, e, o).run(), [ 2 /*return*/ ];
                    }
                }));
            }));
        })), o.promise;
    }(Da(t = aa(t, _a)), (function(n) {
        return e(new ph(t, n));
    }));
}
 ...
 * writes.
 */ function Ih(t) {
    return Da(t = aa(t, _a)), new Jc(t, (function(e) {
        return fh(t, e);
    }))
    /**
 * Cloud Firestore
...
void 0 === dh && (dh = !0), M = i, o(new c("firestore", (function(t, e) {
    var n = e.options, r = t.getProvider("app").getImmediate(), i = new _a(r, new tt(t.getProvider("auth-internal")), new it(t.getProvider("app-check-internal")));
    return n = Object.assign({
        useFetchStreams: dh
    }, n), i._setSettings(n), i;
}), "PUBLIC")), s(P, "3.4.3", void 0), 
// BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
s(P, "3.4.3", "esm5");

export { Wc as AbstractUserDataWriter, Ka as Bytes, Sa as CACHE_SIZE_UNLIMITED, ya as CollectionReference, da as DocumentReference, Tc as DocumentSnapshot, Ba as FieldPath, Ga as FieldValue, _a as Firestore, Y as FirestoreError, za as GeoPoint, Ea as LoadBundleTask, pa as Query, Dc as QueryConstraint, Ec as QueryDocumentSnapshot, Sc as QuerySnapshot, Ic as SnapshotMetadata, lt as Timestamp, ph as Transaction, Jc as WriteBatch, ea as _DatabaseId, Pt as _DocumentKey, ot as _EmptyAppCheckTokenProvider, $ as _EmptyAuthCredentialsProvider, bt as _FieldPath, aa as _cast, Q as _debugAssert, Tt as _isBase64Available, j as _logWarn, ia as _validateIsNotUsedTogether, ah as addDoc, wh as arrayRemove, gh as arrayUnion, La as clearIndexedDbPersistence, va as collection, ma as collectionGroup, la as connectFirestoreEmulator, uh as deleteDoc, vh as deleteField, Ma as disableNetwork, ga as doc, ja as documentId, Ca as enableIndexedDbPersistence, xa as enableMultiTabIndexedDbPersistence, Oa as enableNetwork, jc as endAt, Bc as endBefore, Da as ensureFirestoreConfigured, fh as executeWrite, $c as getDoc, th as getDocFromCache, eh as getDocFromServer, nh as getDocs, rh as getDocsFromCache, ih as getDocsFromServer, ka as getFirestore, bh as increment, Aa as initializeFirestore, Oc as limit, Mc as limitToLast, Va as loadBundle, qa as namedQuery, ch as onSnapshot, hh as onSnapshotsInSync, Lc as orderBy, Nc as query, ba as queryEqual, wa as refEqual, yh as runTransaction, mh as serverTimestamp, oh as setDoc, q as setLogLevel, Ac as snapshotEqual, qc as startAfter, Vc as startAt, Fa as terminate, sh as updateDoc, Pa as waitForPendingWrites, xc as where, Ih as writeBatch };
