...
class Workspaces {
    ...
    readWorkspaceConfiguration() {
        ...
        const nxJson = (0, fs_1.existsSync)(nxJsonPath)
            ? (0, fileutils_1.readJsonFile)(nxJsonPath)
            : {};
...
function globForProjectFiles(root, nxJson) {
    ...
    // Load plugins
    const plugins = (0, nx_plugin_1.loadNxPlugins)(nxJson === null || nxJson === void 0 ? void 0 : nxJson.plugins).filter((x) => !!x.projectFilePatterns);
    let combinedProjectGlobPattern = `**/+(project.json|package.json${plugins.length
